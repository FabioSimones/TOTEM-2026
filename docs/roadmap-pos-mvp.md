...
| TASK-106 | Runbook de operação (documentação) | Documentação | P2 | Documento único: como reiniciar, como rotacionar `JWT_SECRET`, como restaurar backup, o que fazer se o rate limit travar um admin legítimo | `docs/15-runbook-operacao.md` (novo) | Nenhuma (documental) | Depende das decisões de observabilidade (TASK-099) e segredo (TASK-096/097) já estarem tomadas, para não documentar algo que vai mudar |
