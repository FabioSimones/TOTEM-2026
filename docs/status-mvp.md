...
1. Validação visual manual em navegador real do fluxo operacional Totem→Caixa→Cozinha, incluindo o refresh de dispositivo e o login de operador da TASK-092 (a TASK-086 cobriu só o painel Admin; a TASK-089/TASK-092 validaram via `curl`/testes automatizados, não clique real) — última fatia relevante da pendência histórica de "clique real" desde a TASK-060.
