...
- `src/routes/AppRoutes.test.tsx` (TASK-117, novo) — nível de unidade/integração para o roteamento: `/` renderiza `AtivarDispositivoPage`, `/login` renderiza `LoginPage`, `/admin/login` continua redirecionando para `/login`.
