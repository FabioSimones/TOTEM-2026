# TASK-007 - Criar enums do domínio

## Objetivo

Criar StatusPedido, StatusPagamento, FormaPagamento, TipoDispositivo, PerfilUsuario e TipoConsumo.
...
Execute a TASK-007 - Criar enums do domínio.
