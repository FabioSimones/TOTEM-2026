# TASK-015 - Criar pedido

## Objetivo

Criar endpoint para registrar pedido com itens e calcular total no backend.
...
Não iniciar pagamento nesta task.
...
Execute a TASK-015 - Criar pedido.
