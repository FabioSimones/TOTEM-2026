# TASK-020 - Confirmar pagamento em dinheiro

## Objetivo

Criar endpoint para caixa confirmar pagamento e liberar pedido.
...
Não permitir confirmação pelo totem.
...
Execute a TASK-020 - Confirmar pagamento em dinheiro.
