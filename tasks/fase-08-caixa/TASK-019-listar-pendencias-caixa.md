# TASK-019 - Listar pendências do caixa

## Objetivo

Criar endpoint para listar pedidos aguardando pagamento.
...
Não confirmar pagamento nesta task.
...
Execute a TASK-019 - Listar pendências do caixa.
