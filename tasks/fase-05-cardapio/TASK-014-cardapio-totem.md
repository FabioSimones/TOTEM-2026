# TASK-014 - Cardápio para o totem

## Objetivo

Criar endpoint do totem que lista categorias e produtos disponíveis.
...
Não exibir produtos indisponíveis.
...
Execute a TASK-014 - Cardápio para o totem.
