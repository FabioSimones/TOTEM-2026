# TASK-005 - Configurar PostgreSQL e Flyway

## Objetivo

Configurar conexão com PostgreSQL e migrations Flyway.
...
Não criar todas as tabelas ainda se não houver modelagem revisada.
...
Execute a TASK-005 - Configurar PostgreSQL e Flyway.
