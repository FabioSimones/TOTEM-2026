# TASK-006 - Configurar Swagger e tratamento de erros

## Objetivo

Configurar OpenAPI e handler global de exceções.
...
Não criar endpoints de negócio completos.
...
Execute a TASK-006 - Configurar Swagger e tratamento de erros.
