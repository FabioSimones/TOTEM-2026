# TASK-010 - Implementar login administrativo com JWT

## Objetivo

Criar autenticação de usuário humano com JWT e BCrypt.
...
Não implementar ativação de dispositivo ainda.
...
Execute a TASK-010 - Implementar login administrativo com JWT.
