# TASK-001 - Criar estrutura inicial do repositório

## Objetivo

Criar pastas backend, frontend, docs, tasks, skills, agents, prompts, checklists e templates.
...
Não criar backend ainda. Não criar frontend ainda. Não instalar dependências.
...
Execute a TASK-001 - Criar estrutura inicial do repositório.
