# TASK-003 - Criar documentação base

## Objetivo

Criar documentação inicial em /docs com visão, MVP, arquitetura, regras e endpoints.
...
Execute a TASK-003 - Criar documentação base.
